...
def tick_volatile(battle: Battle, ctx: BattleContext, value: Any, name: VolatileName) -> HandlerReturn:
    """揮発状態のターン経過処理
...
def あばれる_on_damage(battle: Battle, ctx: BattleContext, value: Any) -> HandlerReturn:
    """あばれる状態のターン経過処理
