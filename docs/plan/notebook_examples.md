...
- 対象: `examples/**/*.py`（現時点で計31本）、`examples/README.md`、
  ...
  `docs/tests/test_examples_smoke.md`、`pyproject.toml`、
...
- [x] `docs/tests/test_examples_smoke.md` を更新（`scripts/generate_test_list.py`
      実行時に無関係な `docs/tests/items.md` の差分が出たため、そちらは破棄した）
