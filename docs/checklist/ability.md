...
| すなかき | 砂嵐時に素早さ2倍 | ON_CALC_SPEED | すなかき | ✅ | ✅ | ❌ | test_ability.py |
...
| マイペース | こんらん状態を防ぐ（揮発状態） | ON_BEFORE_APPLY_VOLATILE | マイペース | ⚠️ | ❌ | ❌ | こんらん揮発状態実装待ち |
...
| どんかん | メロメロ・ちょうはつを防ぐ | ON_BEFORE_APPLY_VOLATILE | どんかん | ⚠️ | ❌ | ❌ | メロメロ・ちょうはつ揮発状態実装待ち |
