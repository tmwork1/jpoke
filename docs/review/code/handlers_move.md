...
前回の総合レビュー（`docs/review/code/index.md`、2026-07-05付）は `handlers/` 全体を
...
解消済みであり、対応する`docs/review/code/model.md`のCRIT-1記載は現状と乖離しているため
...
（技名を持たない共有ヘルパーの配置基準は`docs/review/code/data_moves.md` ISSUE-3でも
...
`docs/review/code/data_moves.md` ISSUE-3で既に指摘されており、本節はそれに
