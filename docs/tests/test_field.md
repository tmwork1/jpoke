...
- [x] activate_side_field_ひかりのねんどによる延長は反映されない
...
- [x] いやしのねがい_HP減少ポケモンの交代で全回復しフィールドが解除される
- [x] エレキフィールド_ねむけ防止
- [x] エレキフィールド_ねむり防止
- [x] エレキフィールド_ねむる失敗
...
- [x] おいかぜ_相手サイドには補正なし
- [x] おおあめ_こおりが付与される
- [x] オーロラベール_こんらん自傷ダメージは軽減されない
- [x] オーロラベール_ひかりのかべとは重複しない
- [x] オーロラベール_リフレクターとは重複しない
- [x] グラスフィールド_かいふくふうじで回復しない
- [x] グラスフィールド_じしん弱化
- [x] グラスフィールド_じならし弱化
- [x] グラスフィールド_同ターンに瀕死になったポケモンは回復しない
- [x] グラスフィールド_回復
- [x] グラスフィールド_非接地は回復しない
- [x] サイコフィールド_優先度0技は有効
- [x] サイコフィールド_先制技無効
- [x] サイコフィールド_場が対象の優先度技は無効化されない
- [x] サイコフィールド_浮遊は先制技有効
- [x] サイコフィールド_自己対象の優先度技は無効化されない
...
- [x] しんぴのまもり_状態異常防止
- [x] じゅうりょく_Gのちから強化
- [x] じゅうりょく_一撃必殺技は命中補正の対象外
- [x] じゅうりょく_使用禁止技ブロック(move_name=そらをとぶ)
- [x] じゅうりょく_使用禁止技ブロック(move_name=でんじふゆう)
- [x] じゅうりょく_使用禁止技ブロック(move_name=とびげり)
- [x] じゅうりょく_使用禁止技ブロック(move_name=とびはねる)
- [x] じゅうりょく_使用禁止技ブロック(move_name=とびひざげり)
- [x] じゅうりょく_使用禁止技ブロック(move_name=はねる)
- [x] じゅうりょく_使用禁止技ブロック(move_name=フライングプレス)
- [x] じゅうりょく_命中補正
- [x] じゅうりょく_浮遊無効
...
- [x] どくびし_どくタイプはあつぞこブーツでも解除する
- [x] どくびし_はがねタイプには効かない
- [x] どくびし_ふしょく持ちのはがねタイプにも効かない
- [x] どくびし_浮いているポケモンには効かない
- [x] ねがいごと_かいふくふうじ中は回復しない
- [x] ねがいごと_交代後は現在の場のポケモンが回復する
- [x] ねがいごと_同ターンに瀕死になったポケモンは回復しない
- [x] ねがいごと_回復と解除
- [x] ねばねばネット
...
- [x] マジックルーム_再発動で即解除
- [x] マジックルーム_道具効果無効化
- [x] みかづきのまい_いやしのねがいと重複した場合先に設置された方が優先発動する
- [x] みかづきのまい_かいふくふうじ状態でもPPと状態異常は回復するがHPは回復しない
- [x] みかづきのまい_全快ポケモンの交代では消費されず次の回復対象で発動する
- [x] ミストフィールド_ねむる失敗
- [x] ミストフィールド_混乱防止
- [x] ミストフィールド_状態異常防止
- [x] ミストフィールド_非接地は混乱防止されない
- [x] ミストフィールド_非接地は状態異常防止されない
- [x] ゆき_エアロックでこおり防御強化が無効化される
- [x] ゆき_こおり防御強化
- [x] らんきりゅう_エアロックノーてんきで弱点半減が無効化される(ability_name=エアロック)
- [x] らんきりゅう_エアロックノーてんきで弱点半減が無効化される(ability_name=ノーてんき)
...
- [x] リフレクター_こんらん自傷ダメージは軽減されない
- [x] リフレクター_すりぬけは軽減を貫通する
- [x] リフレクター_ワンダールーム中でも物理技を軽減する
- [x] ワンダールーム_再使用で解除
- [x] ワンダールーム_物理技のランク補正はぼうぎょランクのまま
- [x] ワンダールーム_物理技は特防実数値を使用
- [x] ワンダールーム_特殊技のランク補正はとくぼうランクのまま
