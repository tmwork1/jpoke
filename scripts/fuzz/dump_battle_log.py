...
使い方:
    python scripts/fuzz/dump_battle_log.py --seed 12345
    python scripts/fuzz/dump_battle_log.py --seed 12345 --player tree_search --max-plies 1
    python scripts/fuzz/dump_battle_log.py --seed 12345 --out .loop/log_review/seed_12345.log
"""
