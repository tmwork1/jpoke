"""ps-champ-ja (https://github.com/tmwork1/ps-champ-ja) の data_jp/ をローカルの
ps-champ-ja/data_jp/ にダウンロードする。

チャンピオンズシングル向けのポケモン・技・特性等の日本語データの基盤として使う。
"""
import os
...
REPO = "tmwork1/ps-champ-ja"
BRANCH = "main"
SOURCE_DIR = "data_jp"

ROOT = Path(__file__).parent.parent.parent
OUTPUT_DIR = ROOT / "ps-champ-ja" / SOURCE_DIR

API_URL = f"https://api.github.com/repos/{REPO}/contents/{SOURCE_DIR}"
HEADERS = {
    "User-Agent": "jpoke-ps-champ-ja-downloader",
