...
def test_get_item_image_url_gen8サブディレクトリの画像URLを返す():
    assert get_item_image_url("あつぞこブーツ") == (
        "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/gen8/heavy-duty-boots.png"
    )


def test_get_item_image_url_gen9サブディレクトリの画像URLを返す():
    assert get_item_image_url("いかさまダイス") == (
        "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/gen9/loaded-dice.png"
    )
