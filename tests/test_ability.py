...
# TODO かがくへんかガスでも無効化されるテストをパラメタライズで追加
...
# ==== あまのじゃく ====
# ──────────────────────────────────────────────────────────────────
# TODO たんじゅんと同様にテストを実装する

# ──────────────────────────────────────────────────────────────────
# 天候始動
# あめふらし、ひでり、すなおこし、ゆきふらし、おおあめ、おおひでり、デルタストリーム
# ──────────────────────────────────────────────────────────────────
# TODO 強天候特性ともテストを統合できるところはパラメタライズ化する
...
# エアロック / ノーてんき
# ──────────────────────────────────────────────────────────────────
# TODO パラメタライズでエアロックとノーてんきをまとめてテストする
...
def test_おやこあい_2ヒット目のみダメージが減衰する():
    ...
    # 1発目を100ダメージで固定する
    battle.determine_damage = lambda *args, **kwargs: 100
    battle.advance_turn()
    defender = battle.actives[1]
...
# ──────────────────────────────────────────────────────────────────
# 技カテゴリによる威力強化
# かたいツメ、がんじょうあご、メガランチャー、パンクロック、すてみ
# ──────────────────────────────────────────────────────────────────
...
# ==== 接触カウンター系 ====
# TODO : 他の状態異常付与特性(どくのとげ、ほのおのからだ)とまとめてパラメタライズで実装
