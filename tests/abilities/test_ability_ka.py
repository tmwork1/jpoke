...
def test_がんじょう_こんらんの自傷ダメージでもHP1残る():
    ...
    HP満タン時はがんじょうでHP1残る（.internal/spec/abilities/がんじょう.md 参照）。"""
    battle = t.start_battle(
        team0=[Pokemon("コイル", ability_name="がんじょう")],
        team1=[Pokemon("ピカチュウ")],
        volatile0={"こんらん": 2},
...
def test_ききかいひ_ちからずくの技のダメージでも発動する():
    ...
    .internal/spec/abilities/ききかいひ.md参照）。"""
    battle = t.start_battle(
        team0=[Pokemon("ピカチュウ", ability_name="ききかいひ"), Pokemon("ライチュウ")],
...
def test_ぎゃくじょう_ちからずくの技を受けても発動する():
    ...
    通常通り発動する（.internal/spec/abilities/ちからずく.md参照）。"""
    battle = t.start_battle(
...
def test_こぼれダネ_致命打でも発動する():
    ...
    （seed=2225 fuzz_log 回帰テスト。.internal/spec/abilities/こぼれダネ.md）"""
    battle = t.start_battle(
        team0=[Pokemon("ピカチュウ", ability_name="こぼれダネ")],
        team1=[Pokemon("カビゴン", move_names=["たいあたり"])],
    )
